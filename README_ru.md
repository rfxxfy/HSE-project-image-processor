...
Список фильтров может быть пуст, тогда изображение сохранено в неизменном виде.
...
#### Smoothing (-cm radius)
Сглаживает изображение в соответствии с заданным радиусом. Чем больше значение радиуса, тем сильнее применяется эффект.


## Реализация

Для чтения и записи файлов используется [std::ifstream](https://en.cppreference.com/w/cpp/io/basic_ifstream) и [std::ofstream](https://en.cppreference.com/w/cpp/io/basic_ofstream).
